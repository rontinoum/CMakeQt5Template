...
MACRO(SETLINKDEPENDENCIES)    
    ...
    IF(${PROJECT_DYNAMIC})
        ...
        FOREACH(PrjExecutable ${PrjExecutables})
            FOREACH(EXTERNALLIB ${${PrjExecutable}_EXTERNALLIBS})
                TARGET_LINK_LIBRARIES(${PrjExecutable} ${EXTERNALLIB})
            ENDFOREACH(EXTERNALLIB ${${PrjExecutable}_EXTERNALLIBS})
        ENDFOREACH(PrjExecutable ${PrjExecutables})
        
        FOREACH(PrjLibrary ${PrjLibraries})
            FOREACH(EXTERNALLIB ${${PrjLibrary}_EXTERNALLIBS})
                TARGET_LINK_LIBRARIES(${PrjLibrary} ${EXTERNALLIB})
            ENDFOREACH(EXTERNALLIB ${${PrjLibrary}_EXTERNALLIBS})
        ENDFOREACH(PrjLibrary ${PrjLibraries})
    ELSE(${PROJECT_DYNAMIC})
        ...
        SET(EXTERNALLINKTARGETS)        
        FOREACH(PrjExecutable ${PrjExecutables})
            FOREACH(EXTERNALLIB ${${PrjExecutable}_EXTERNALLIBS})
                LIST(APPEND EXTERNALLINKTARGETS ${EXTERNALLIB})
            ENDFOREACH(EXTERNALLIB ${${PrjExecutable}_EXTERNALLIBS})
        ENDFOREACH(PrjExecutable ${PrjExecutables})
        ...
        LIST(REMOVE_DUPLICATES EXTERNALLINKTARGETS)
        FOREACH(PrjExecutable ${PrjExecutables})
            FOREACH(EXTERNALLIB ${EXTERNALLINKTARGETS})
                TARGET_LINK_LIBRARIES(${PrjExecutable} ${EXTERNALLIB})
            ENDFOREACH(EXTERNALLIB ${EXTERNALLINKTARGETS})
        ENDFOREACH(PrjExecutable ${PrjExecutables})
